...
const CardProject = ({ nameProject, logoProject, calificacionProject }) => {
  return (
    <div className="group border-2 border-gray-600 bg-white shadow-xl w-full m-5 rounded-xl hover:underline hover:shadow-2xl hover:scale-95 transform delay-150 transition duration-300 ease-in-out">
